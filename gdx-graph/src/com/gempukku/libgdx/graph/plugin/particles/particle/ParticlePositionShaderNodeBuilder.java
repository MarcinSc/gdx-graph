...
public class ParticlePositionShaderNodeBuilder extends ConfigurationShaderNodeBuilder {
    public ParticlePositionShaderNodeBuilder() {
        super(new ParticlePositionShaderNodeConfiguration());
    }
