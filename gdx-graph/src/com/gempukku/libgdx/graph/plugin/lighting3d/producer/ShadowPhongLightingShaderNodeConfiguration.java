...
public class ShadowPhongLightingShaderNodeConfiguration extends DefaultMenuNodeConfiguration {
    public ShadowPhongLightingShaderNodeConfiguration() {
        super("ShadowPhongLighting", "Shadowed Phong lighting", "Lighting");
        addNodeInput(
