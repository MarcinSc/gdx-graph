...
public class SaturatePipelineNodeConfiguration extends DefaultMenuNodeConfiguration {
    public SaturatePipelineNodeConfiguration() {
        super("Saturate", "Saturate", "Math/Common");
        addNodeInput(
