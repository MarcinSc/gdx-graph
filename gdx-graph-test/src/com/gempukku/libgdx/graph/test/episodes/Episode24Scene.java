...
import com.gempukku.libgdx.graph.artemis.particle.ParticleBatchSystem;
...
public class Episode24Scene implements LibgdxGraphTestScene {
    ...
    public void initializeScene() {
        ...
        spawnSystem.spawnEntities("entity/2dscene/episode24/episode24-setup.entities");

        world.process();

        // Load environment
        spawnSystem.spawnEntities("entity/2dscene/episode24/episode24-environment.entities");
        ...
        DefaultParticleGenerator particleGenerator = new DefaultParticleGenerator(5, 0, 20);
        particleGenerator.setPropertyGenerator("Position", new PositionPropertyGenerator(positionGenerator));
        particleGenerator.setPropertyGenerator("UV", new DefaultPropertyGenerator(SpriteSystem.uvAttribute));
        particleGenerator.setPropertyGenerator("X movement",
                new PropertyGenerator() {
                    @Override
                    public Object generateProperty(float seed) {
                        return MathUtils.random(-50f, 50f);
                    }
                });
        particleGenerator.setPropertyGenerator("Y movement",
                new PropertyGenerator() {
                    @Override
                    public Object generateProperty(float seed) {
                        return MathUtils.random(-50f, 50f);
        ...
        particleGenerator.setPropertyGenerator("Parallax Random",
                new PropertyGenerator() {
                    @Override
                    public Object generateProperty(float seed) {
                        return MathUtils.random(0.8f, 0.99f);
                    }
                });
        particleGenerator.setPropertyGenerator("Color Random",
                new PropertyGenerator() {
                    @Override
                    public Object generateProperty(float seed) {
                        return MathUtils.random(0f, 1f);
                    }
                });
        particleGenerator.setPropertyGenerator("Size",
                new PropertyGenerator() {
                    @Override
                    public Object generateProperty(float seed) {
                        return MathUtils.random(5f, 15f);
                    }
                });
        world.getSystem(ParticleBatchSystem.class).addParticleGenerator("dustParticles", particleGenerator);
