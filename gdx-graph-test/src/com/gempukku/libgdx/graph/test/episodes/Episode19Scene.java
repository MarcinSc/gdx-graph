...
public class Episode19Scene implements LibgdxGraphTestScene {
    ...
    public void initializeScene() {
        ...
        spawnSystem.spawnEntities("entity/2dscene/episode19/episode19-setup.entities");

        world.process();

        // Load environment
        spawnSystem.spawnEntities("entity/2dscene/episode19/episode19-environment.entities");
