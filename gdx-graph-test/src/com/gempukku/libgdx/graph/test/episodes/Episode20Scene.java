...
public class Episode20Scene implements LibgdxGraphTestScene {
    ...
    private void loadEnvironment(Json json) {
        EntityLoader.readEntity(engine, json, "sprite/platform.json");
    ...
    private PipelineRenderer loadPipelineRenderer() {
        PipelineRenderer pipelineRenderer = PipelineLoader.loadPipelineRenderer(Gdx.files.local("episodes/episode20.json"), timeKeeper);
