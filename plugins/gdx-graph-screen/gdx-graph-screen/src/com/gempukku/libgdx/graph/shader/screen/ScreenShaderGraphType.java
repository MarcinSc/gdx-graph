...
public class ScreenShaderGraphType implements ShaderGraphType {
    ...
    private static final GraphConfiguration[] configurations = new GraphConfiguration[]{new ModelShaderConfiguration(), new PropertyShaderConfiguration(), new ScreenShaderConfiguration()};
