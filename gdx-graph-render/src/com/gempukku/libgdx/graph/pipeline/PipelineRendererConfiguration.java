...
public class PipelineRendererConfiguration implements Disposable {
    ...
    public PipelineRendererConfiguration(TimeProvider timeProvider) {
        this(timeProvider, null, null, null);
    }

    public PipelineRendererConfiguration(
